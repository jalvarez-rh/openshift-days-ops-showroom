...
**Key takeaway:** `oc get clusteroperators` is your primary health check. All operators showing `True False False` means a healthy cluster ready for workloads. Beyond that, ensure the monitoring operator is healthy and verify etcd health — these two underpin everything else on the platform.
