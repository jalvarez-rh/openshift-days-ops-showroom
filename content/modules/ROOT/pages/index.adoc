...
In the top-left corner of the console, you'll see a perspective switcher dropdown. Make sure **Administrator** is selected.

If necessary, click the dropdown and select **Administrator** → **Fleet Management**
