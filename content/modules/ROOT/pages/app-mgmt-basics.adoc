...
You'll be taken to the Topology view where you can see the application deployed:

image::app-mgmt-deploy-topology.png[Topology view showing weathernow application running]

Click the route URL to see the WeatherNow app in your browser:
