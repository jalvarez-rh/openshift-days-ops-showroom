...
else echo "WARNING: No vendor has 2+ nodes — migration may not work"; VENDOR="Intel"; fi

echo "Cluster has $INTEL_COUNT Intel and $AMD_COUNT AMD nodes — pinning to $VENDOR"

# Check if VM is already on the right vendor
